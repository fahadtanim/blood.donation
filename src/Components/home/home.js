...
class Home extends Component {
   ...
   handleRegisterFormSubmit = () =>{
    ...
    handleSignInFormSubmit = () =>{
      ...
      console.log(user);
      axios.post("http://139.59.91.220:8080/bloodbank/api/bloodBank/v1/exhort/login", user)
      .then(result => {
          ...
          <div className="card white darken-1">
            <div className="card-content z-depth-0 red-text">
              <span className="card-title center"
                >BLOOD DONATION REDUCES RISK OF CANCER, HYPERTENSION AND HEART
                DISEASE</span
              >
            </div>
          </div>
          ...
          <form className="col s12" action="">
              ...
              <div className="col s6">
                <select className="row" defaultValue = '0'>
                  <option value="0" disabled
                    >Blood Group / রক্তের গ্রুপ</option
                  >
            ...
            <div className="input-field row">
              ...
              <div className="col s8">
                <select className="row" defaultValue = '0'>
                  <option value="0" disabled 
                    >e.g. Whole Blood/Apheresis Platelets/FFP etc</option
                  >
    ...
    <div id="signInModal" className="modal modal-fixed-footer">
      <div className="modal-content">
        ...
        <div className = "row">
          <button className="modal-close row waves-effect waves-light btn-large" onClick={this.handleSignInFormSubmit}>
                Sign In
              </button>
          </div>
      </div>
    ...
    <div id = "registerModal" className = "modal">
            ...
            <div className="col s12">
                ...
                <div className="row">
                        <div className="input-field col s12">
                            <input id="register_email" type="email" className="validate"/>
